...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{10.5pt}
        \fontsize{12.045pt}{18.067pt}\selectfont{Generalization performance under DNN learning process of semantic image concepts}\\
        \vspace{10.5pt}
...
\input{main_sec/01_intro} 
    
\input{main_sec/02_relatedwork}

\input{main_sec/03_experiment_settings}

\input{main_sec/04_experiments}

\input{main_sec/05_results}

\input{main_sec/06_discussion}

\input{main_sec/07_conclusion}

\input{main_sec/08_futurework}

\bibliographystyle{IEEEtran}
\bibliography{ref/mybibfile.bib}

\appendix
\input{main_sec/zza_appendix}

\input{main_sec/zzb_appendix}

\input{main_sec/zzp_presentation}

\input{main_sec/xx_acknowledgment.tex}
